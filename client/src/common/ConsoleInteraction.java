...
public class ConsoleInteraction {
	...
	public static int readCharInput() {
		...
		try {
			...
			// Read the first character entered
			keyCode = reader.read();
		} catch (Exception e) {
	...
	/**
	 * Propose a numeric choice to the user between 2 values (inclusive)
	 * 
	...
	/**
	 * Display colored text in the console
	 * 
	...
	/**
	 * Display information text surrounded by dashes
	 * 
	 * @param text The text to display
	 * 
	 * @see ConsoleInteraction#TEXT_RESET
	 */
	public static void printInfo(String text, String color) {
